...
The **SSM** aspect of the project focused on implementing **SOLID principles** and the **MVVM (Model-View-ViewModel)** architecture. We also created sequence diagrams [(here)](https://github.com/MiljanaMa/Booking/tree/main/Diagrams/SequenceDiagrams), activity diagrams [(here)](https://github.com/MiljanaMa/Booking/tree/main/Diagrams/ActivityDiagrams), use case diagram [(here)](https://github.com/MiljanaMa/Booking/tree/main/Diagrams/UseCaseDiagram) and a class diagram [(here)](https://github.com/MiljanaMa/Booking/tree/main/Diagrams/ClassDiagram) to better understand the data flow and application structure.
