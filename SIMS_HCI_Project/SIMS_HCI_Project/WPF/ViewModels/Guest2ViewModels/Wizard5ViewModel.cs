...
namespace SIMS_HCI_Project.WPF.ViewModels.Guest2ViewModels
{
    public class Wizard5ViewModel
    {
        ...
        public Wizard5ViewModel(Wizard5View wizard5View, Guest2 guest2, NavigationService navigationService)
        {
        ...
        {
            NavigationService.Navigate(new Wizard4View(Guest, NavigationService));
        }
